...
//? console compilation and execution
// gcc is the compiler
// -g integrates debugging infos
// -Wall shows all compilation errors
// hw.c and functions.c are source code files
// -o hw create the executable file
// ./hw executes it
//? gcc -g -Wall hw.c functions.c -o hw && ./hw
...
// (gdb) "watch" variable - return changesxhj
